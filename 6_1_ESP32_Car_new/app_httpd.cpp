...
static esp_err_t command_handler(httpd_req_t *req){
    ...
    else if (direction.equals("t_right")){
      txdata[1] = Top_Right;
      Serial.write(txdata, 3);
    }
    else if (direction.equals("t_left")){
      txdata[1] = Top_Left;
      Serial.write(txdata, 3);
    }
    else if (direction.equals("b_right")){
      txdata[1] = Bottom_Right;
      Serial.write(txdata, 3);
    }
    else if (direction.equals("b_left")){
      txdata[1] = Bottom_Left;
      Serial.write(txdata, 3);
    }
    else if (direction.equals("right_rotate")){
      txdata[1] = Clockwise;
      Serial.write(txdata, 3);
    }
    else if (direction.equals("left_rotate")){
